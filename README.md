# Set Geolocation in Mocha Tests on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can set Geolocation in Mocha Tests across real browsers and operating systems.
