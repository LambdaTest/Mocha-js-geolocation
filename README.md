...
If you want to run your automation test for a particular location in Mocha.js on TestMu AI (Formerly LambdaTest), you can use the following steps. You can refer to sample test repo [here](https://github.com/LambdaTest/mocha-selenium-sample).
